 ...
 */
if (file_exists(DRUPAL_ROOT . '/../settings/settings.huijse2.database.php')) {
  include DRUPAL_ROOT . '/../settings/settings.huijse2.database.php';
}
if (empty($databases)) {
 ...
 * Public files path.
 */
$settings['file_public_path'] = 'sites/huijse2/files';

/**
 * Private files outside the docroot.
 */
$settings['file_private_path'] = '../private_files/huijse2';
